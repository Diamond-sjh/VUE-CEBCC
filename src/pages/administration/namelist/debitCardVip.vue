          ...
          <el-col :span="11">
            <el-form-item label="数据类型">
              <el-select v-model="form.dataType" style="width:100%" placeholder="请选择类型">
                ...
                <el-option label="自动导入" value="2"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        </el-form>
        <el-col :span="24">
          <el-button type="primary" plain size="small" @click="debitVipListquery()">查询</el-button>
        </el-col>
      </el-row>
    <!-- 查询列表开始 -->
    <el-row>
    ...
    <queryResTable :pageSize="20" pagePosition="right" :url="postUrl" :params="params" :pageSizes="[20]" @dataChanged="dataChangedCallback" height="300" ref="tableBox" :reloadData.sync="reloadData">
      <template v-slot:paginationContainer>
        <el-table ref="multipleTable" :data="paramTableData" tooltip-effect="dark" stripe max-height="500" border @selection-change="handleSelectionChange">
          ...
          <el-table-column label="状态" prop="status" :formatter="formstatus"></el-table-column>
        ...
        <el-form :model="form_add" :rules="rules" ref="form_add" label-width="120px" class="demo-ruleForm">
          <el-col :span="11">
            <el-form-item label="账号" prop="cardNo">
              <el-input v-model="form_add.cardNo" maxlength="25"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
           ...
           <el-col :span="11">
            <el-form-item label="客户号" prop="custNo">
              <el-input v-model="form_add.custNo" maxlength="10"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item label="客户号" prop="custNo" v-show="addorchange==='change'">
              <span>{{form_add.custNo}}</span>
            </el-form-item>
          </el-col>
            <el-col :span="11">
          ...
          <el-col :span="11">
            <el-form-item label="信用卡客户等级" prop="creditLeveo">
              <el-input v-model="form_add.creditLeveo" maxlength="20"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="11">
            <el-form-item label="借记卡客户等级" prop="debitLeveo">
              <el-input v-model="form_add.debitLeveo" maxlength="20"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item label="客户特点" prop="contentment">
              <el-input v-model="form_add.contentment" maxlength="20"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="11">
            <el-form-item label="专职指定座席" prop="specifyAgent">
              <el-input v-model="form_add.specifyAgent" maxlength="20"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="11">
            <el-form-item label="客户贡献度" prop="custOfferdegree">
              <el-input v-model="form_add.custOfferdegree" maxlength="20"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="11">
            <el-form-item label="利润贡献度" prop="gainOfferdegree">
              <el-input v-model="form_add.gainOfferdegree" maxlength="20"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="11">
            <el-form-item label="签约手机号" prop="signMobio">
              <el-input v-model="form_add.signMobio" maxlength="11"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
          ...
          <el-col :span="11">
            <el-form-item label="备注1" prop="remark1">
              <el-input v-model="form_add.remark1" maxlength="50"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item label="备注2" prop="remark2">
              <el-input v-model="form_add.remark2" maxlength="50"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item label="备注3" prop="remark3">
              <el-input v-model="form_add.remark3" maxlength="50"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item label="备注4" prop="remark4">
              <el-input v-model="form_add.remark4" maxlength="50"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item label="备注5" prop="remark5">
              <el-input v-model="form_add.remark5" maxlength="50"></el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  data() {
     var validatecardNo = (rule, value, callback) => {
      ...
      if (value === "") {
        ...
        if (pattern.test(value)) {
          ...
          callback(new Error("最大可以输入25位数字"));
        }
      }
    };
    ...
    var validatecertId = (rule, value, callback) => {
      var patten = /^\d{1,18}$/;
       if (value === "") {
        callback(new Error("请输入数字"));
      } else {
    ...
    var validatesignMobio = (rule, value, callback) => {
      var patten = /^\d{11}$/;
       if (value === "") {
        callback(new Error("请输入数字"));
      } else {
    ...
    return {
      ...
      pageSize: 10,
      pagePosition: "",
      postUrl: urlConfig.admin.queryDebitVipList,
      params: "",
      form: {
        certId: "",
        status: "",
  ...
  methods: {
    ...
    dataChangedCallback(response) {
      this.paramTableData =
        response ? response.debitVipList : [];
    ...
    adminaddSub(formdata) {
      this.$refs[formdata].validate(val => {
        if (val) {
          ...
          this.$MainAjax
            .doPost(urlConfig.admin.saveDebitVipList, param)
            .then(res => {
              console.log(res);
    ...
    changeAdminPara() {
      ...
      this.dialogVisible = true;
      this.title = "修改";
      this.form_add.debitVipId = this.multipleSelection[0].debitVipId;
      ...
      this.form_add.remark5= this.multipleSelection[0].remark5//参数备注
    ...
    adminchangeSub(formdata) {
      this.$refs[formdata].validate(val => {
        if (val) {
          let param = {
            debitVipId :this.form_add.debitVipId,
            custNo: this.form_add.custNo,
            custLike: this.form_add.custLike,
            custName: this.form_add.custName,
            birteday: this.form_add.birteday,
          ...
          this.$MainAjax
            .doPost(urlConfig.admin.updateDebitVip, param)
            .then(res => {
              console.log(res);
      ...
      this.$confirm("是否确认删除", "确认框", {
        ...
        .then(() => {
          ...
          for (let i = 0; i < this.multipleSelection.length; i++) {
            ...
            debitVipId.push(this.multipleSelection[i].debitVipId);
          }
          let params = { debitVipId: debitVipId.join(",") };

          this.$MainAjax
            .doPost(urlConfig.admin.delDebitVip, params)
            .then(res => {
